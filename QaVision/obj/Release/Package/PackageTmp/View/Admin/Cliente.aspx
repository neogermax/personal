<%@ Page Title="" Language="C#" MasterPageFile="~/View/Master/Master.Master" AutoEventWireup="true" CodeBehind="Cliente.aspx.cs" Inherits="QaVision.View.Admin.Cliente" %>
    ...
    <div class="col-xs-12 col-sm-12">
        <div class="card">
            <div class="card-header">
                <strong id="TForm">Ver Clientes</strong>
            </div>
            <div class="card-body card-block">
                ...
                <div id="BlockForm" style="display: none;">
                    <div class="row">
                        ...
                        <div class="col-xs-4 col-sm-4">
                            <div class="form-group">
                                <label for="TxtNit" class="control-label mb-1">Nit</label>
                                <input id="TxtNit" name="TxtNit" type="text" maxlength="250" class="form-control Numeric" aria-required="true" aria-invalid="false">
                                <label id="helpNit" class="Help"></label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-xs-10 col-sm-10">
                        <h4 class="modal-title" style="font-weight: bold; color: #8e8e8e; font-size: 25px;">Activar - Desactivar Cliente</h4>
                    </div>
