<%@ Page Title="" Language="C#" MasterPageFile="~/View/Master/Master.Master" AutoEventWireup="true" CodeBehind="HistoricoPassword.aspx.cs" Inherits="QaVision.View.Report.HistoricoPassword" %>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-xs-10 col-sm-10">
                        <h4 class="modal-title" style="font-weight: bold; color: #8e8e8e; font-size: 25px;">Visualización y descarga del PDF</h4>
                    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="server">
    ...
    <script src="HistoricoPassword.js"></script>
</asp:Content>
