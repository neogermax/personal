...
function MenuLateral(vp_Option) {
    ...
    switch (vp_Option) {
        ...
        case 9:
            ...
            break;
        case 10:
            window.location = "../FinalReports/Filtros.aspx";
            break;
        case 11:
            window.location = "../FinalReports/PlantillaReport.aspx";
            break;
        case 12:
            window.location = "../FinalReports/Productividad.aspx";
            break;
    }
}
...
//funcion que calcula el numero de la semana
...
//disparador
function CalculaNumberWeek(vp_Anio, vp_Mes, vp_Dia) {

    //new Date(2020, 01, 01).getWeekNumber();
    var vl_Num = new Date(vp_Anio, vp_Mes, vp_Dia).getWeekNumber();
    return vl_Num = vl_Num - 4;
}
